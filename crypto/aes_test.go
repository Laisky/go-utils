...
func TestHMAC(t *testing.T) {
	...
	expected := []byte{0x9, 0x5d, 0x5a, 0x21, 0xfe, 0x6d, 0x6, 0x46, 0xdb, 0x22, 0x3f, 0xdf, 0x3d, 0xe6, 0x43, 0x6b, 0xb8, 0xdf, 0xb2, 0xfa, 0xb0, 0xb5, 0x16, 0x77, 0xec, 0xf6, 0x44, 0x1f, 0xcf, 0x5f, 0x2a, 0x67}

	for i := 0; i < 5; i++ {
		result, err := HMACSha256(key, data)
		require.NoError(t, err)
